...
export default {
    ...
    data() {
        return {
            ...
            colors1: [
                ...
                // typeColor[0], typeColor[1], typeColor[2], typeColor[3], typeColor[4],
                // typeColor[5], typeColor[6], typeColor[7], typeColor[8], typeColor[9],
            ], // 分类色系
            sxValues1: [],
    ...
    methods: {
        ...
        clickR2Point(ev, flag) {
            ...
            dChart.on('plot:click', (ev) => {
                ...
                fetch(localhost + jzid + '/' + yljgml + '/rank2Click_s2')
                    ...
                    .then((data) => {
                        ...
                        dChart = pie('R2chart2', typeColor, data['s2'])
                        dChart.render()
                    })
            ...
            dChart = pie('R2chart2', typeColor, ev['s2'])
            dChart.render()
            scene.addPopup(new Popup({
                    offsets: [0, 0],
                    closeButton: false
